            ...
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center gap-0.5">
                ...
                >
                  <button
                    className={cn(
                      "flex items-center gap-1.5 text-[13px] font-black tracking-[0.06em] uppercase transition-colors duration-200 group whitespace-nowrap",
          ...
          <AnimatePresence>
            {servicesOpen && (
              <motion.div
                ...
                onMouseLeave={closeServices}
              >
                {/* pt-3 creates hover bridge; the padding area is part of this wrapper */}
